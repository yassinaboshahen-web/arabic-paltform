...
export const ContinueLearningHero: React.FC<ContinueLearningHeroProps> = ({
  ...
  return (
    <section 
      id="dashboard-continue-learning-hero"
    ...
    >
      {/* Subtle Atmospheric Burgundy & Champagne Background Glow */}
      <div className="absolute top-0 right-1/4 w-96 h-96 bg-[#651F2A]/15 rounded-full blur-3xl pointer-events-none -z-0" />
      <div className="absolute bottom-0 left-10 w-80 h-80 bg-[#D6B978]/5 rounded-full blur-3xl pointer-events-none -z-0" />
      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 p-6 sm:p-8 lg:p-10 items-center">
        ...
        {/* Right Column in RTL: Course Info, Lesson Breadcrumbs, Progress, Actions */}
        <div className="lg:col-span-7 space-y-6 text-right order-2 lg:order-1">
          ...
          <div className="space-y-2">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#181614] border border-[#D6B978]/30 text-[#D6B978] text-xs font-semibold">
              ...
              <span className="text-[#AAA39A]">آخر درس شاهدته: {course.lastAccessed}</span>
            </div>
          ...
          <div className="p-4 sm:p-5 rounded-2xl bg-[#0C0B0A]/80 border border-[#292521] space-y-3">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-[#292521] pb-3">
              <div className="flex items-center gap-2.5">
                <div className="w-2.5 h-2.5 rounded-full bg-[#D6B978] animate-pulse" />
              ...
              <div className="flex items-center justify-between text-xs text-[#AAA39A]">
                <div className="flex items-center gap-2 truncate">
                  ...
                  <span className="truncate text-[#F5F1E8]/90 font-medium">
                    {course.nextLesson.orderNumber}: {course.nextLesson.title}
                  </span>
                </div>
          ...
          {/* Progress Bar & Academic Metadata */}
          <div className="space-y-2">
            <div className="flex items-center justify-between text-xs sm:text-sm">
              ...
              <div className="flex items-center gap-3 text-xs text-[#AAA39A] font-mono">
                ...
                <span className="text-[#777169]">•</span>
                <span className="flex items-center gap-1 text-[#AAA39A]">
                  <Clock className="w-3.5 h-3.5 text-[#D6B978]" />
                  <span>{course.durationRemaining}</span>
                </span>
              </div>
            </div>

            {/* Champagne Progress Line */}
            <div className="w-full h-2 rounded-full bg-[#181614] border border-[#292521] overflow-hidden">
              <div 
                className="h-full bg-gradient-to-l from-[#D6B978] to-[#E7D29A] rounded-full transition-all duration-700 ease-out shadow-[0_0_12px_rgba(214,185,120,0.4)]"
        ...
        {/* Left Column in RTL: Large Cinematic Course Poster */}
        <div className="lg:col-span-5 relative order-1 lg:order-2">
          <div className="relative rounded-2xl overflow-hidden aspect-[16/10] lg:aspect-[4/3] border border-[#292521] shadow-2xl group">
            ...
            {/* Dark & Burgundy Overlay Gradients */}
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <button
                ...
                className="w-16 h-16 rounded-full bg-[#D6B978]/90 group-hover:bg-[#E7D29A] text-[#070707] flex items-center justify-center shadow-2xl backdrop-blur-md transition-all duration-300 transform group-hover:scale-110"
              >
